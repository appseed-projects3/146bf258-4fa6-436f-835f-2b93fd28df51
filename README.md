...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-07-05 16:07`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/146bf258-4fa6-436f-835f-2b93fd28df51.git
$ cd 146bf258-4fa6-436f-835f-2b93fd28df51
```
